...
export function IncomingCall() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm animate-fade-in">
      <div className="w-[380px] bg-bg-surface border border-border rounded-3xl p-8 shadow-2xl animate-slide-up">
        ...
        <div className="text-center mb-2">
          <p className="text-xs text-text-muted uppercase tracking-wider mb-2">Incoming Call</p>
        ...
        <div className="mt-6 mb-8 p-3 bg-bg rounded-xl border border-border">
          <div className="grid grid-cols-2 gap-2 text-xs">
            <div>
              ...
              <p className="text-text font-mono">{incomingCall.remoteNumber}</p>
            </div>
            <div>
              <span className="text-text-muted">Extension:</span>
              <p className="text-text font-mono">{incomingCall.localNumber}</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-6 justify-center">
          <div className="flex flex-col items-center gap-2">
            <button
              ...
              className="w-16 h-16 rounded-full bg-error hover:bg-red-600 flex items-center justify-center transition-all duration-200 glow-error active:scale-90"
            >
            ...
            <span className="text-xs text-text-secondary">Reject</span>
          </div>

          <div className="flex flex-col items-center gap-2">
            <button
              onClick={handleAnswer}
              className="w-16 h-16 rounded-full bg-success hover:bg-emerald-500 flex items-center justify-center transition-all duration-200 glow-success active:scale-90"
            >
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-white">
                <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/>
              </svg>
