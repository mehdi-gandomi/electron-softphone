    ...
    <div className="flex flex-col h-full">
      ...
      <div className="title-bar">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-text">تلفن نرم‌افزاری</span>
        </div>
        <div className="flex items-center gap-1">
          ...
          <button onClick={() => window.api.window.toggleAlwaysOnTop()} className="title-bar-btn text-text-secondary" title="همیشه رو">
